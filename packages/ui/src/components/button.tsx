...
const buttonVariants = cva(
  'inline-flex items-center gap-1 justify-center font-medium whitespace-nowrap rounded-md transition-colors focus-visible:outline-none ',
  {
    variants: {
      variant: {
        default: 'dark:bg-zinc-100 dark:text-zinc-800 text-white bg-zinc-800 hover:opacity-90',
        ...
        secondary: 'bg-zinc-500/15 text-zinc-800 dark:text-white opacity-100 hover:opacity-80 ',
        ghost: 'hover:bg-zinc-500/15 text-zinc-800 dark:text-white opacity-100 hover:opacity-80',
