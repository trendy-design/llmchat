...
export const providers = ['llmchat', 'openai', 'anthropic', 'gemini', 'ollama', 'groq'] as const;

export const ollamaModelsSupportsTools = ['llama3-groq-tool-use:latest', 'llama3.2:3b'];
