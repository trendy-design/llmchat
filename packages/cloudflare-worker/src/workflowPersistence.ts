import { ContextSchemaDefinition, EventSchemaDefinition, WorkflowConfig } from '@repo/orchestrator';
...
// Define the shape of persisted workflow data
export type WorkflowPersistenceData<
...
export class WorkflowPersistenceLayer<
    TEvent extends EventSchemaDefinition = any,
    TContext extends ContextSchemaDefinition = any,
> {
