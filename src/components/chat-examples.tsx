      ...
      <div className="grid grid-cols-3 gap-4 w-[700px]">
        {examplePrompts?.map((example, index) => (
          <motion.div
            ...
            className="flex bg-white shadow-sm dark:bg-zinc-800 flex-col gap-2 items-start text-sm py-3 px-4 border border-dark/10 dark:border-white/5 text-zinc-600 dark:text-zinc-400 w-full rounded-2xl hover:bg-zinc-50 dark:hover:bg-black/20 cursor-pointer"
            key={index}
            animate={{
