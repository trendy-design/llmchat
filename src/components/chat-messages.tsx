    ...
    return (
      <div className="flex flex-col gap-1 items-end w-full" key={message.id}>
        {message.props?.context && (
          <div className="bg-zinc-50 text-zinc-600 dark:text-zinc-100 dark:bg-black/30 rounded-2xl p-2 pl-3 text-sm flex flex-row gap-2 pr-4 border hover:border-white/5 border-transparent">
            <ArrowElbowDownRight
              size={20}
              weight="bold"
        ...
        <div className="bg-zinc-50 text-zinc-600 dark:text-zinc-100 dark:bg-black/30 ml-16 rounded-2xl text-sm flex flex-row gap-2 px-3 py-2">
