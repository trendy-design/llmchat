/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8e3f9dbbd57d894622ea5f88af1edb24)
// Runtime types generated with workerd@1.20250416.0 2024-03-01 cache_option_enabled,nodejs_compat_populate_process_env,nodejs_compat_v2,rpc
declare namespace Cloudflare {
	interface Env {
		...
		FREE_CREDITS_LIMIT_REQUESTS: string;
		FREE_CREDITS_LIMIT_REQUESTS_IP: string;
		DATABASE_URL: string;
		WORKFLOW_STATE: DurableObjectNamespace<import("./src/index").WorkflowStateObject>;
	}
}
