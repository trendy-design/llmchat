...
import { allPlugins, defaultPreferences, models, ollamaModelsSupportsTools } from "@repo/shared/config";
import { TAssistant, TModelItem, TModelKey } from "@repo/shared/types";
