...
export const CitationProvider = ({ block, children }: PropsWithChildren<{ block: Block }>) => {
        ...
        useEffect(() => {
                ...
                setCitations(uniqueCitations.reduce((citations, url, index) => {
        ...
        return <CitationProviderContext.Provider value={{ citations }}>{children}</CitationProviderContext.Provider>;
};
