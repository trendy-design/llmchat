        ...
        case 'PENDING':
            return (
                <span className="relative flex size-3 items-center justify-center">
                    <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-yellow-500/50 opacity-75"></span>
                    <span className="relative inline-flex size-2 rounded-full bg-yellow-500/50"></span>
                </span>
            );
        case 'COMPLETED':
            return (
                <span className="relative flex size-3 items-center justify-center">
                    <span className="relative flex size-2">
                        <span className="relative inline-flex size-2 rounded-full bg-yellow-700/50"></span>
                    </span>
                </span>
            );
        case 'ERROR':
