...
export const Sidebar = () => {
  ...
  const renderGroup = (title: string, threads: Thread[]) => {
    ...
    return (
      <Flex gap="xs" direction="col" items="start" className="w-full">
        <Type size="xs" weight="regular" className="px-2 py-1 text-zinc-500">
          {title}
        </Type>
  ...
  return (
    <div className="border-border/50 relative flex h-[100dvh] w-[240px] flex-shrink-0 flex-row border-r bg-[#F9F9F9]">
      <Flex direction="col" className="no-scrollbar w-full">
        ...
        {false ? (
          ...
          <Flex
            direction="col"
            gap="md"
            className="no-scrollbar border-border/50 w-full flex-1 overflow-y-auto border-t p-2"
          >
