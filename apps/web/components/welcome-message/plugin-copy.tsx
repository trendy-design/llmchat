...
const PluginItem = ({
  ...
  return (
    <ExplainationCard explanation={explanation}>
      <div
        className={cn(
          'mx-1 flex flex-row items-center gap-1 rounded-full border border-zinc-500/20 bg-white px-2 py-0.5 text-sm font-medium shadow-sm md:px-2 md:py-1 dark:bg-zinc-800',
